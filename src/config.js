...
const CONFIG = {
  ...
  // 素材の行によっては向きの揃っていないコマが混ざっているため、揃っているコマだけを使う。
  //   上: 1〜4コマ目が正面向き、5〜8コマ目が背面向き → 背面の4コマだけ使う
  //   右: 1,2,3,5コマ目が左を向いている → 右を向いている4コマだけ使う
  //   左: assets/character.png 生成時に「右」の行を左右反転して作っているので、
  //       右と同じコマ番号を使う (詳細は README)
  frameSequence: {
    up: [4, 5, 6, 7],
    right: [3, 5, 6, 7],
    left: [3, 5, 6, 7],
